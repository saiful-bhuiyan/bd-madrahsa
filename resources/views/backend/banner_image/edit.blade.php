    ...
    <div class="row">
        <div class="col-md-12">
            <div class="ibox">
                ...
                <div class="ibox-body">
                    <form method="post" action="{{route('banner_image.update',$data->id)}}">
                        @csrf
                        @method('PUT')
                        <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-12" id="inputSingleBox">
                            ...
                            <div class="col-lg-6 col-md-6 col-12" id="inputSingleBox">
                                ...
                                <label for="defaultFormControlInput" class="form-label">@lang('banner_image.description_en') <span class="text-danger">*</span></label>
                                    <textarea class="form-control" placeholder="@lang('banner_image.description_en')" id="textAreaExample1" name="description_en" >
                                    {{$data->description_en}}
                                    </textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-12" id="inputSingleBox">
                                ...
                                <label for="defaultFormControlInput" class="form-label">@lang('banner_image.description_bn') <span class="text-danger">*</span></label>
                                    <textarea class="form-control" placeholder="@lang('banner_image.description_bn')" id="textAreaExample1" name="description_bn" >
                                    {{$data->description_bn}}
                                    </textarea>
                                </div>
                            </div>
