    ...
    <div class="row">
        <div class="col-md-12">
            <div class="ibox">
                ...
                <div class="ibox-body">
                    <form method="post" action="{{route('sub_academic_detail.update',$data->id)}}">
                        @csrf
                        @method('PUT')
                        <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-12" id="inputSingleBox">
                                <div>
                                    ...
                                    <select class="form-control" name="ad_id">
                                        ...
                                        <option value="{{$a->id}}" @if($a->id == $data->ad_id) selected  @endif>@if($lang == 'en'){{$a->title_en}}@elseif($lang=="bn"){{$a->title_bn}}@endif</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
