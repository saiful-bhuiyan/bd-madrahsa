    ...
    <div class="row">
        <div class="col-md-12">
            <div class="ibox">
                ...
                <div class="ibox-body">
                    <form method="post" action="{{route('sub_nav_information.update',$data->id)}}">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-12" id="inputSingleBox">
                                <div>
                                    ...
                                    <select class="form-control" id="sub_nav_id" name="sub_nav_id">
                                        <option value="{{$check_sub_nav->id}}">@if($lang == 'en'){{$check_sub_nav->sub_nav_name_en}}@elseif($lang=="bn"){{$check_sub_nav->sub_nav_name_bn}}@endif</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-12" id="inputSingleBox">
                                ...
                                <input
                                    ...
                                    placeholder="@lang('sub_nav_information.title_en')"
                            ...
                            <div class="col-lg-6 col-md-6 col-12" id="inputSingleBox">
                                ...
                                <input
                                    ...
                                    class="form-control"
                                    id="defaultFormControlInput"
                                    placeholder="@lang('sub_nav_information.title_bn')"
                                    aria-describedby="defaultFormControlHelp"
                                    name="title_bn"
                                    required
                                    value="{{$data->title_bn}}"
